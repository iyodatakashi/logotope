 ...
 */
export const assessActiveAgendaItem = llmTask(
	'agenda-assessment',
	async (
 ...
 */
export const generateInterventionUtterance = llmTask(
...
export const generateOpening = llmTask(
	'facilitator-opening',
	async (
		topicTitle: string,
		personas: Persona[],
		...
		try {
			...
			const entryPoint = hasPoints && firstChapter ? firstChapter.agenda[0] : firstChapter?.title;
...
export const generateChapterIntroduction = llmTask(
	'facilitator-chapter-intro',
	async (
		nextChapter: Chapter,
		personas: Persona[],
		factBase?: FactBase
