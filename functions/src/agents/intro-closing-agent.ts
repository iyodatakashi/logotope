...
const introClosingSystemPrompt = `あなたはテレビ討論番組の司会者です。番組の導入（イントロ）と結び（クロージング）を、スタジオで視聴者に語りかける司会者の言葉として話します。以下の制約を絶対に守ってください。
...
【禁止表現】
- 中身のない番組常套句は使わない。「ぜひ最後までお付き合いください」「ご覧ください」「次回もお楽しみに」のような、視聴・購読を促すだけの決まり文句は禁止。
...
【文体】
- 司会者が視聴者へ落ち着いて語りかける、です・ます調の散文（である調・体言止め・断定の言い切りは使わない）。
- 見出し・箇条書きは使わない。討論と同じ言語で書く。`;

const introInstruction = `これは番組の冒頭で、司会者がこれから始まる討論へ視聴者を引き込む導入の言葉です。この先を見たいと思わせるのが唯一の目的です。

大前提: これから見る視聴者は、このテーマに深い論点があることをまだ知りません。だから「重要で深い問いがあります」と説き起こしても響きません。深い論点は、討論を見ることで視聴者が初めて手にする新しい視点であって、イントロで先出しするものではありません。

入り口にするのは、視聴者がすでに素朴に気にしていること——「今これがどうなっているのか」という、誰もが自然に追える現在の状況です。共感を演出しないこと。「〜と気になりますよね」「〜と思う人も多いでしょう」のように視聴者の気持ちを実況・代弁して共感を作りにいかない。素朴な事実をそのまま短く置けば、共感は自然に生まれます。

おおむね次の流れで、司会者が視聴者に語りかける言葉として話してください。全体は3文前後・1段落の短さに収めます:
1. このテーマが今どういう状況にあるのかを、テーマ説明や参考資料に即して、具体的な事実で一文描く。
2. 視聴者が素朴に追える具体を、最も印象に残るものだけ一つ二つ選んで厚みを出す。深い論点・分析・評価は加えない。
...
- 視聴者本人に問いかけない。「あなたならどうしますか」のように視聴者に答えを求める問いは禁止。締めの問いは討論が向き合う問いであって、視聴者への質問ではありません。
- 事実を置いたら、締めの問い以外に論評・まとめの一言を足さない（「今後の展開が注目されます」「目が離せません」のような、中身のない後付けの締め文句は不要）。
- 短く、まっすぐ書く。`;

const outroInstruction = `これは番組の最後に、司会者が視聴者へ語りかける結びの言葉です。視聴者は討論を最後まで見終えています。
- 「論点を整理します」のような前置きで始めない。「第1章ではこう、第2章では…」と各章の内容を順になぞり返す振り返りもしない（視聴者はもう見て知っている）。
- 討論という場の終演を実況して締めない。「議論は幕を下ろす／閉じる」「白熱した議論でした」のように、討論が終わったことそのものを描写しない。残った問いを、司会者自身の言葉で視聴者の前に静かに置いて締める。
