...
export const generateTurn = llmTask(
	'turn',
	async (
		persona: Persona,
...
type EvaluateEngagementOptions = {
	...
	onAwarenessDropped?: (
		reason: 'source-mismatch' | 'listener-is-speaker' | 'empty-content'
	) => void;
};

export const evaluateEngagement = llmTask(
	'engagement',
	async (
		persona: Persona,
		turns: DebateTurn[],
		...
		try {
			...
			let resolvedMode: 'opinion' | 'fact' | 'none' | 'question' =
...
export const generateImpression = llmTask(
	'impression',
	async (
		persona: Persona,
		turns: DebateTurn[],
