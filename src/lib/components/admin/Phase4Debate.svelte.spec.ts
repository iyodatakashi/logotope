  ...
  createSessionStore: vi.fn(() => ({
    get session() {
      return {
        turns: [
          {
            id: 't1', turnIndex: 1, speakerType: 'persona', personaId: 'p1',
            content: 'テスト発言内容', createdAt: {}, speechMode: undefined,
          },
        ],
        status: 'completed',
        createdAt: {},
...
vi.mock('$lib/stores/personas.svelte.js', () => ({
  createPersonasStore: vi.fn(() => ({
    get personas() {
      return [
        { id: 'p1', name: '田中太郎', stakeholderRole: '医師', beliefs: [], approved: true, age: 45, occupation: '外科医', background: '', interests: '', stanceDirection: 'pro', sortOrder: 0, topicId: 't1' },
        { id: 'p2', name: '鈴木花子', stakeholderRole: '患者', beliefs: [], approved: true, age: 35, occupation: '会社員', background: '', interests: '', stanceDirection: 'against', sortOrder: 1, topicId: 't1' },
      ];
    },
    get isLoaded() { return true; },
    start: vi.fn(),
...
import Phase4Debate from './Phase4Debate.svelte';
